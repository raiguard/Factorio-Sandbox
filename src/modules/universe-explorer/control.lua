  ...
  local refs = gui.build(player.gui.screen, {
    {
      ...
      ref = { "window" },
      {
        ...
        ref = { "titlebar_flow" },
        {
          type = "label",
          style = "frame_title",
          caption = "[img=virtual-signal/se-planet-orbit]  Universe explorer  [[color=128, 206, 240]U[/color]]",
          ignored_by_interaction = true,
        },
      ...
      {
        type = "flow",
        style_mods = { height = 744, horizontal_spacing = 12 },
        {
          type = "frame",
          ...
          direction = "vertical",
          {
            ...
            priority_display(),
            { type = "empty-widget", style = "flib_horizontal_pusher" },
            { type = "textfield", style_mods = { font_color = { 0.25, 0.25, 0.25 } }, text = "Search..." },
          },
          {
            type = "frame",
            style = "subheader_frame",
        ...
        },
        {
          ...
          direction = "vertical",
          {
            ...
            },
            {
              ...
              { type = "checkbox", style = "se_selected_sort_checkbox", caption = "Details", state = false },
              ...
              { type = "line", direction = "horizontal" },
              { type = "checkbox", style = "se_selected_sort_checkbox", caption = "Resources", state = false },
          ...
          },
          {
            ...
            style_mods = { top_margin = -8 },
            {
              ...
              style_mods = { size = 31, top_margin = 1 },
            ...
            { type = "sprite-button", style = "tool_button_blue", style_mods = { size = 32 }, sprite = "se_scan" },
            { type = "sprite-button", style = "tool_button", style_mods = { size = 32 }, sprite = "flib_pin_black" },
            {
              type = "button",
